...
-%
5}%
&FlangeSlope&94&Zpz(cm3)&361000.0\\%
\cline{2%
-%
5}%
...
-%
5}%
&FlangeSlope&91.5&Zpz(cm3)&116000.0\\%
\cline{2%
-%
5}%
...
\endhead%
\hline%
Shear Capacity (kN)&&$\begin{aligned}V_{dsb} &= \frac{f_ub ~n_n~ A_{nb}}{\sqrt{3} ~\gamma_{mb}}\\ &= \frac{410*1*84.3}{\sqrt{3}~*~1.25}\\ &= 11.68\end{aligned}$&\\%
\hline%
Bearing Capacity (kN)&&$\begin{aligned}V_{dpb} &= \frac{2.5~ k_b~ d~ t~ f_u}{\gamma_{mb}}\\ &= \frac{2.5~*0.52*12.0*3.7*410}{1.25}\\ &=11.68\end{aligned}$&\\%
\hline%
Capacity (KN)&&$\begin{aligned}V_{db} &= min~ (V_{dsb}, V_{dpb})\\ &= min~ (11.68,11.68)\\ &=11.68\end{aligned}$&\\%
\hline%
No of Bolts&$\begin{aligned}R_{u} &= \sqrt{V_u^2+A_u^2}\\ n_{trial} &= R_u/ V_{bolt}\\ R_{u} &= \frac{\sqrt{1.0^2+1.0^2}}{11.68}\\ &=1\end{aligned}$&2&\\%
\hline%
No of Columns&&1&\\%
\hline%
No of Rows&&2&\\%
...
\hline%
Max. End Distance (mm)&$\begin{aligned}e/e`_{max} &= 12~ t~ \varepsilon&\\ \varepsilon &= \sqrt{\frac{250}{f_y}}\\ e/e`_{max}&=12 ~*4.0*\sqrt{\frac{250}{230}}\\ &=49.92\\ \end{aligned}$&25&Pass\\%
\hline%
Min. Edge Distance (mm)&$\begin{aligned}e/e`_{min} &=[1.5~or~ 1.7] * d_0\\ &=1.7*13.0=22.1 \end{aligned}$&25&Pass\\%
\hline%
Max. Edge Distance (mm)&$\begin{aligned}e/e`_{max} &= 12~ t~ \varepsilon&\\ \varepsilon &= \sqrt{\frac{250}{f_y}}\\ e/e`_{max}&=12 ~*4.0*\sqrt{\frac{250}{230}}\\ &=49.92\\ \end{aligned}$&25&Pass\\%
\hline%
Capacity (KN)&1039.86&11680.95&Pass\\%
\hline%
\end{longtable}
...
\hline%
Shear yielding Capacity (V\_dy) (kN)&&$\begin{aligned} V_{dg} &= \frac{A_v*f_y}{\sqrt{3}*\gamma_{mo}}\\ &=\frac{135*4.0*230}{\sqrt{3}*1.1}\\ &=39.11\end{aligned}$&\\%
\hline%
...
\hline%
Block Shear Capacity in Shear (V\_db) (kN)&&79.79&\\%
\hline%
Shear Capacity (V\_d) (kN)&1.0&$\begin{aligned} V_d &= Min(V_{dy},V_{dn},V_{db})\\ &= Min(39.11,134.07,79.79)\\ &=39.11\end{aligned}$&Pass\\%
\hline%
Tension Yielding Capacity (kN)&&$\begin{aligned} T_{dg} &= \frac{l*t*f_y}{\gamma_{mo}}\\ &=\frac{60.0*4.0*230}{\sqrt{3}*1.1}\\ &=50.18\end{aligned}$&\\%
\hline%
Tension Rupture Capacity(kN)&&$\begin{aligned} T_{dn} &= \frac{0.9*A_{n}*f_u}{\gamma_{m1}}\\ &=\frac{0.9*(60.0-2*13.0)*4.0*410}{1.25}\\ &=55.5\end{aligned}$&\\%
\hline%
Block Shear Capacity in Tension (T\_db) (kN)&&79.79&\\%
\hline%
Tension Capacity (kN)&1.0&$\begin{aligned} T_d &= Min(T_{dg},T_{dn},T_{db})\\ &= Min(50.18,55.5,79.79)\\ &=50.18\end{aligned}$&Pass\\%
\hline%
Moment Capacity (kNm)&0.04&3.05&Pass\\%
\hline%
Interaction Ratio&$\begin{aligned} \leq1\end{aligned}$&$\begin{aligned} \frac{0.04}{3.05}+\frac{1.0}{50.18}=0.03\end{aligned}$&Pass\\%
\hline%
\end{longtable}
...
\hline%
Weld Strength (kN/mm)&$\begin{aligned} R_w&=\sqrt{(T_{wh}+A_{wh})^2 + (T_{wv}+V_{wv})^2}\\ T_{wh}&=\frac{M*y_{max}}{I{pw}}=\frac{35000.0*64.5}{357781.5}\\ T_{wv}&=\frac{M*x_{max}}{I{pw}}=\frac{35000.0*0.0}{357781.5}\\ V_{wv}&=\frac{V}{l_w}=\frac{1000.0}{258}\\ A_{wh}&=\frac{A}{l_w}=\frac{1000.0}{258}\\ R_w&=\sqrt{(6.31+3.88)^2 + (0.0+3.88)^2}\\ &=10.9\end{aligned}$&$\begin{aligned} f_w &=\frac{t_t*f_u}{\sqrt{3}*\gamma_{mw}}\\ &=\frac{3*410}{\sqrt{3}}*1.25\\ &=568.11\end{aligned}$&Pass\\%
\hline%
\end{longtable}

...
\hline%
Max. Plate Height (mm)&$\begin{aligned} &d_b - t_{bf} + r_{b1} - notch_h\\ &=250.0-12.5+13.0-30\\ &=200.0\end{aligned}$&200&Pass\\%
\hline%
...
\endhead%
\hline%
Min Weld Size (mm)&$\begin{aligned} Thickness~of~Thicker~part&\\ =Max(8.5,8.5)&=8.5\\ IS800:2007~cl.10.5.2.3~Table 21,&\\ t_{w_{min}} &=3\end{aligned}$&3&Pass\\%
\hline%
Max Weld Size (mm)&$\begin{aligned} Thickness~of~Thinner~part&\\ =Min(8.5,8.5)&=8.0\\ t_{w_{max}} &=8.0\end{aligned}$&3&Pass\\%
\hline%
Weld Strength (kN/mm)&$\begin{aligned} R_w&=\sqrt{(T_{wh}+A_{wh})^2 + (T_{wv}+V_{wv})^2}\\ T_{wh}&=\frac{M*y_{max}}{I{pw}}=\frac{2750000.0*97.0}{1216897.33}\\ T_{wv}&=\frac{M*x_{max}}{I{pw}}=\frac{2750000.0*0.0}{1216897.33}\\ V_{wv}&=\frac{V}{l_w}=\frac{50000.0}{388}\\ A_{wh}&=\frac{A}{l_w}=\frac{50000.0}{388}\\ R_w&=\sqrt{(219.21+128.87)^2 + (0.0+128.87)^2}\\ &=371.16\end{aligned}$&$\begin{aligned} f_w &=\frac{t_t*f_u}{\sqrt{3}*\gamma_{mw}}\\ &=\frac{3*290}{\sqrt{3}}*1.25\\ &=568.11\end{aligned}$&Pass\\%
\hline%
\end{longtable}

...
\hline%
\hline%
\multirow{13}{*}{\includegraphics[width=5cm,height=5cm]{"C:/Users/nitin/Pictures/Saved Pictures/Osdag3/ResourceFiles/images/ISection".png}}&\multicolumn{2}{|c|}{Supporting Section}&\multicolumn{2}{|c|}{PBP 360X152}\\%
\cline{2%
-%
5}%
...
\hline%
\hline%
\multirow{13}{*}{\includegraphics[width=5cm,height=5cm]{"C:/Users/nitin/Pictures/Saved Pictures/Osdag3/ResourceFiles/images/ISection".png}}&\multicolumn{2}{|c|}{Supported Section}&\multicolumn{2}{|c|}{MB 200}\\%
\cline{2%
-%
5}%
&\multicolumn{2}{|c|}{Material *}&\multicolumn{2}{|c|}{E 250 (Fe 410 W)A}\\%
...
\endhead%
\hline%
Shear Capacity (kN)&&$\begin{aligned}V_{dsb} &= \frac{f_ub ~n_n~ A_{nb}}{\sqrt{3} ~\gamma_{mb}}\\ &= \frac{410*1*157}{\sqrt{3}~*~1.25}\\ &= 36.26\end{aligned}$&\\%
\hline%
Bearing Capacity (kN)&&$\begin{aligned}V_{dpb} &= \frac{2.5~ k_b~ d~ t~ f_u}{\gamma_{mb}}\\ &= \frac{2.5~*0.49*16.0*5.7*410}{1.25}\\ &=36.26\end{aligned}$&\\%
\hline%
Capacity (KN)&&$\begin{aligned}V_{db} &= min~ (V_{dsb}, V_{dpb})\\ &= min~ (36.26,36.26)\\ &=36.26\end{aligned}$&\\%
\hline%
No of Bolts&$\begin{aligned}R_{u} &= \sqrt{V_u^2+A_u^2}\\ n_{trial} &= R_u/ V_{bolt}\\ R_{u} &= \frac{\sqrt{50.0^2+50.0^2}}{36.26}\\ &=2\end{aligned}$&4&\\%
\hline%
No of Columns&&2&\\%
\hline%
No of Rows&&2&\\%
...
\hline%
Capacity (KN)&35382.95&36257.6&Pass\\%
\hline%
\end{longtable}
...
\hline%
Shear yielding Capacity (V\_dy) (kN)&&$\begin{aligned} V_{dg} &= \frac{A_v*f_y}{\sqrt{3}*\gamma_{mo}}\\ &=\frac{150*6.0*230}{\sqrt{3}*1.1}\\ &=65.19\end{aligned}$&\\%
\hline%
...
\hline%
Shear Capacity (V\_d) (kN)&50.0&$\begin{aligned} V_d &= Min(V_{dy},V_{dn},V_{db})\\ &= Min(65.19,210.33,175.56)\\ &=65.19\end{aligned}$&Pass\\%
\hline%
...
\hline%
Block Shear Capacity in Tension (T\_db) (kN)&&175.56&\\%
\hline%
Tension Capacity (kN)&50.0&$\begin{aligned} T_d &= Min(T_{dg},T_{dn},T_{db})\\ &= Min(150.55,148.78,175.56)\\ &=148.78\end{aligned}$&Pass\\%
\hline%
Moment Capacity (kNm)&3.25&5.65&Pass\\%
\hline%
Interaction Ratio&$\begin{aligned} \leq1\end{aligned}$&$\begin{aligned} \frac{3.25}{5.65}+\frac{50.0}{148.78}=0.91\end{aligned}$&Pass\\%
\hline%
\end{longtable}
...
\endhead%
\hline%
Min Weld Size (mm)&$\begin{aligned} Thickness~of~Thicker~part&\\ =Max(17.9,17.9)&=17.9\\ IS800:2007~cl.10.5.2.3~Table 21,&\\ t_{w_{min}} &=5\end{aligned}$&6&Pass\\%
\hline%
Max Weld Size (mm)&$\begin{aligned} Thickness~of~Thinner~part&\\ =Min(17.9,17.9)&=6.0\\ t_{w_{max}} &=6.0\end{aligned}$&6&Fail\\%
\hline%
Weld Strength (kN/mm)&$\begin{aligned} R_w&=\sqrt{(T_{wh}+A_{wh})^2 + (T_{wv}+V_{wv})^2}\\ T_{wh}&=\frac{M*y_{max}}{I{pw}}=\frac{3250000.0*69.0}{438012.0}\\ T_{wv}&=\frac{M*x_{max}}{I{pw}}=\frac{3250000.0*0.0}{438012.0}\\ V_{wv}&=\frac{V}{l_w}=\frac{50000.0}{276}\\ A_{wh}&=\frac{A}{l_w}=\frac{50000.0}{276}\\ R_w&=\sqrt{(511.97+181.16)^2 + (0.0+181.16)^2}\\ &=716.41\end{aligned}$&$\begin{aligned} f_w &=\frac{t_t*f_u}{\sqrt{3}*\gamma_{mw}}\\ &=\frac{4.2*410}{\sqrt{3}}*1.25\\ &=795.36\end{aligned}$&Pass\\%
\hline%
\end{longtable}

...
\hline%
Max. Gauge (mm)&$\begin{aligned}p/g_{max} &=\min(32~t,~300~mm)&\\ &=\min(32 *~7.7,~ 300 ~mm)\\&=300\end{aligned}$&110&Pass\\%
\hline%
...
\endhead%
\hline%
Min. Plate Height (mm)&$\begin{aligned}0.6 * d_b&= 0.6 * 300.0=180.0\end{aligned}$&200&Pass\\%
\hline%
Max. Plate Height (mm)&$\begin{aligned} &d_b - 2 (t_{bf} + r_{b1} + gap)\\ &=300.0- 2* (13.1+14.0+ 10)\\ &=245.8\end{aligned}$&200&Pass\\%
\hline%
...
\endhead%
\hline%
Min Weld Size (mm)&$\begin{aligned} Thickness~of~Thicker~part&\\ =Max(31.4,31.4)&=31.4\\ IS800:2007~cl.10.5.2.3~Table 21,&\\ t_{w_{min}} &=6\end{aligned}$&6&Pass\\%
\hline%
Max Weld Size (mm)&$\begin{aligned} Thickness~of~Thinner~part&\\ =Min(31.4,31.4)&=8.0\\ t_{w_{max}} &=8.0\end{aligned}$&6&Pass\\%
\hline%
Weld Strength (kN/mm)&$\begin{aligned} R_w&=\sqrt{(T_{wh}+A_{wh})^2 + (T_{wv}+V_{wv})^2}\\ T_{wh}&=\frac{M*y_{max}}{I{pw}}=\frac{2750000.0*94.0}{1107445.33}\\ T_{wv}&=\frac{M*x_{max}}{I{pw}}=\frac{2750000.0*0.0}{1107445.33}\\ V_{wv}&=\frac{V}{l_w}=\frac{50000.0}{376}\\ A_{wh}&=\frac{A}{l_w}=\frac{50000.0}{376}\\ R_w&=\sqrt{(233.42+132.98)^2 + (0.0+132.98)^2}\\ &=389.78\end{aligned}$&$\begin{aligned} f_w &=\frac{t_t*f_u}{\sqrt{3}*\gamma_{mw}}\\ &=\frac{4.2*290}{\sqrt{3}}*1.25\\ &=795.36\end{aligned}$&Pass\\%
\hline%
\end{longtable}

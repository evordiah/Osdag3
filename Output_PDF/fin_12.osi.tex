...
\endhead%
\hline%
Min Weld Size (mm)&$\begin{aligned} Thickness~of~Thicker~part&\\ =Max(14,14)&=14\\ IS800:2007~cl.10.5.2.3~Table 21,&\\ t_{w_{min}} &=5\end{aligned}$&5&Pass\\%
\hline%
Max Weld Size (mm)&$\begin{aligned} Thickness~of~Thinner~part&\\ =Min(14,14)&=8.0\\ t_{w_{max}} &=8.0\end{aligned}$&5&Pass\\%
\hline%
Weld Strength (kN/mm)&$\begin{aligned} R_w&=\sqrt{(T_{wh}+A_{wh})^2 + (T_{wv}+V_{wv})^2}\\ T_{wh}&=\frac{M*y_{max}}{I{pw}}=\frac{2500000.0*85.0}{818833.33}\\ T_{wv}&=\frac{M*x_{max}}{I{pw}}=\frac{2500000.0*0.0}{818833.33}\\ V_{wv}&=\frac{V}{l_w}=\frac{50000.0}{340}\\ A_{wh}&=\frac{A}{l_w}=\frac{50000.0}{340}\\ R_w&=\sqrt{(259.52+147.06)^2 + (0.0+147.06)^2}\\ &=432.35\end{aligned}$&$\begin{aligned} f_w &=\frac{t_t*f_u}{\sqrt{3}*\gamma_{mw}}\\ &=\frac{3.5*410}{\sqrt{3}}*1.25\\ &=662.8\end{aligned}$&Pass\\%
\hline%
\end{longtable}

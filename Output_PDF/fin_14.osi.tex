...
\endhead%
\hline%
Shear Capacity (kN)&&$\begin{aligned}V_{dsb} &= \frac{f_ub ~n_n~ A_{nb}}{\sqrt{3} ~\gamma_{mb}}\\ &= \frac{410*1*157}{\sqrt{3}~*~1.25}\\ &= 41.85\end{aligned}$&\\%
\hline%
Bearing Capacity (kN)&&$\begin{aligned}V_{dpb} &= \frac{2.5~ k_b~ d~ t~ f_u}{\gamma_{mb}}\\ &= \frac{2.5~*0.49*16.0*6.5*410}{1.25}\\ &=41.85\end{aligned}$&\\%
\hline%
Capacity (KN)&&$\begin{aligned}V_{db} &= min~ (V_{dsb}, V_{dpb})\\ &= min~ (41.85,41.85)\\ &=41.85\end{aligned}$&\\%
\hline%
No of Bolts&$\begin{aligned}R_{u} &= \sqrt{V_u^2+A_u^2}\\ n_{trial} &= R_u/ V_{bolt}\\ R_{u} &= \frac{\sqrt{70.0^2+50.0^2}}{41.85}\\ &=3\end{aligned}$&4&\\%
\hline%
No of Columns&&2&\\%
\hline%
No of Rows&&2&\\%
...
\hline%
Max. End Distance (mm)&$\begin{aligned}e/e`_{max} &= 12~ t~ \varepsilon&\\ \varepsilon &= \sqrt{\frac{250}{f_y}}\\ e/e`_{max}&=12 ~*8.0*\sqrt{\frac{250}{230}}\\ &=99.84\\ \end{aligned}$&35&Pass\\%
\hline%
Min. Edge Distance (mm)&$\begin{aligned}e/e`_{min} &=[1.5~or~ 1.7] * d_0\\ &=1.7*18.0=30.6 \end{aligned}$&35&Pass\\%
\hline%
Max. Edge Distance (mm)&$\begin{aligned}e/e`_{max} &= 12~ t~ \varepsilon&\\ \varepsilon &= \sqrt{\frac{250}{f_y}}\\ e/e`_{max}&=12 ~*8.0*\sqrt{\frac{250}{230}}\\ &=99.84\\ \end{aligned}$&35&Pass\\%
\hline%
Capacity (KN)&39971.83&41850.37&Pass\\%
\hline%
\end{longtable}
...
\hline%
Shear yielding Capacity (V\_dy) (kN)&&$\begin{aligned} V_{dg} &= \frac{A_v*f_y}{\sqrt{3}*\gamma_{mo}}\\ &=\frac{175*8.0*230}{\sqrt{3}*1.1}\\ &=101.4\end{aligned}$&\\%
\hline%
...
\hline%
Block Shear Capacity in Shear (V\_db) (kN)&&258.22&\\%
\hline%
Shear Capacity (V\_d) (kN)&70.0&$\begin{aligned} V_d &= Min(V_{dy},V_{dn},V_{db})\\ &= Min(101.4,341.94,258.22)\\ &=101.4\end{aligned}$&Pass\\%
\hline%
Tension Yielding Capacity (kN)&&$\begin{aligned} T_{dg} &= \frac{l*t*f_y}{\gamma_{mo}}\\ &=\frac{120.0*8.0*230}{\sqrt{3}*1.1}\\ &=200.73\end{aligned}$&\\%
\hline%
Tension Rupture Capacity(kN)&&$\begin{aligned} T_{dn} &= \frac{0.9*A_{n}*f_u}{\gamma_{m1}}\\ &=\frac{0.9*(120.0-2*18.0)*8.0*410}{1.25}\\ &=198.37\end{aligned}$&\\%
\hline%
Block Shear Capacity in Tension (T\_db) (kN)&&258.22&\\%
\hline%
Tension Capacity (kN)&50.0&$\begin{aligned} T_d &= Min(T_{dg},T_{dn},T_{db})\\ &= Min(200.73,198.37,258.22)\\ &=198.37\end{aligned}$&Pass\\%
\hline%
Moment Capacity (kNm)&4.55&10.25&Pass\\%
\hline%
Interaction Ratio&$\begin{aligned} \leq1\end{aligned}$&$\begin{aligned} \frac{4.55}{10.25}+\frac{50.0}{198.37}=0.7\end{aligned}$&Pass\\%
\hline%
\end{longtable}
...
\endhead%
\hline%
Min Weld Size (mm)&$\begin{aligned} Thickness~of~Thicker~part&\\ =Max(11,11)&=11\\ IS800:2007~cl.10.5.2.3~Table 21,&\\ t_{w_{min}} &=5\end{aligned}$&6&Pass\\%
\hline%
Max Weld Size (mm)&$\begin{aligned} Thickness~of~Thinner~part&\\ =Min(11,11)&=8.0\\ t_{w_{max}} &=8.0\end{aligned}$&6&Fail\\%
\hline%
Weld Strength (kN/mm)&$\begin{aligned} R_w&=\sqrt{(T_{wh}+A_{wh})^2 + (T_{wv}+V_{wv})^2}\\ T_{wh}&=\frac{M*y_{max}}{I{pw}}=\frac{4550000.0*81.5}{721791.17}\\ T_{wv}&=\frac{M*x_{max}}{I{pw}}=\frac{4550000.0*0.0}{721791.17}\\ V_{wv}&=\frac{V}{l_w}=\frac{70000.0}{326}\\ A_{wh}&=\frac{A}{l_w}=\frac{50000.0}{326}\\ R_w&=\sqrt{(513.76+153.37)^2 + (0.0+214.72)^2}\\ &=700.84\end{aligned}$&$\begin{aligned} f_w &=\frac{t_t*f_u}{\sqrt{3}*\gamma_{mw}}\\ &=\frac{4.2*410}{\sqrt{3}}*1.25\\ &=795.36\end{aligned}$&Pass\\%
\hline%
\end{longtable}

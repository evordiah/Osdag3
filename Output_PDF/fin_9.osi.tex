...
\endhead%
\hline%
Min Weld Size (mm)&$\begin{aligned} Thickness~of~Thicker~part&\\ =Max(6.1,6.1)&=8.0\\ IS800:2007~cl.10.5.2.3~Table 21,&\\ t_{w_{min}} &=3\end{aligned}$&3&Pass\\%
\hline%
Max Weld Size (mm)&$\begin{aligned} Thickness~of~Thinner~part&\\ =Min(6.1,6.1)&=6.1\\ t_{w_{max}} &=6.1\end{aligned}$&3&Pass\\%
\hline%

...
-%
5}%
&FlangeSlope&94&Zpz(cm3)&1090000.0\\%
\cline{2%
-%
5}%
...
\hline%
Bearing Capacity (kN)&&$\begin{aligned}V_{dpb} &= \frac{2.5~ k_b~ d~ t~ f_u}{\gamma_{mb}}\\ &= \frac{2.5~*0.52*12.0*3.4*410}{1.25}\\ &=11.68\end{aligned}$&\\%
\hline%
...
\hline%
Capacity (KN)&11180.34&11680.95&Pass\\%
\hline%
\end{longtable}
...
\hline%
Shear yielding Capacity (V\_dy) (kN)&&$\begin{aligned} V_{dg} &= \frac{A_v*f_y}{\sqrt{3}*\gamma_{mo}}\\ &=\frac{120*4.0*230}{\sqrt{3}*1.1}\\ &=34.77\end{aligned}$&\\%
\hline%
...
\hline%
Block Shear Capacity in Shear (V\_db) (kN)&&72.55&\\%
\hline%
Shear Capacity (V\_d) (kN)&10.0&$\begin{aligned} V_d &= Min(V_{dy},V_{dn},V_{db})\\ &= Min(34.77,115.62,72.55)\\ &=34.77\end{aligned}$&Pass\\%
\hline%
...
\hline%
Block Shear Capacity in Tension (T\_db) (kN)&&72.55&\\%
\hline%
Tension Capacity (kN)&10.0&$\begin{aligned} T_d &= Min(T_{dg},T_{dn},T_{db})\\ &= Min(50.18,55.5,72.55)\\ &=50.18\end{aligned}$&Pass\\%
\hline%
Moment Capacity (kNm)&0.35&2.41&Pass\\%
\hline%
Interaction Ratio&$\begin{aligned} \leq1\end{aligned}$&$\begin{aligned} \frac{0.35}{2.41}+\frac{10.0}{50.18}=0.34\end{aligned}$&Pass\\%
\hline%
\end{longtable}
...
\endhead%
\hline%
Min Weld Size (mm)&$\begin{aligned} Thickness~of~Thicker~part&\\ =Max(11.6,11.6)&=11.6\\ IS800:2007~cl.10.5.2.3~Table 21,&\\ t_{w_{min}} &=4.0\end{aligned}$&4&Pass\\%
\hline%
Max Weld Size (mm)&$\begin{aligned} Thickness~of~Thinner~part&\\ =Min(11.6,11.6)&=4.0\\ t_{w_{max}} &=4.0\end{aligned}$&4&Pass\\%
\hline%

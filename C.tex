...
\hline%
\rowcolor{OsdagGreen}%
Date&27 /04 /2020&Client&LoremIpsum\\%
\hline%
\end{tabularx}
}%
\fancyfoot[R]{ 
...
\endhead%
\hline%
Shear Capacity (kN)&&$\begin{aligned}V_{dsb} &= \frac{f_ub ~n_n~ A_{nb}}{\sqrt{3} ~\gamma_{mb}}\\ &= \frac{410*1*353}{\sqrt{3}~*~1.25}\\ &= 97.08\end{aligned}$&\\%
\hline%
Bearing Capacity (kN)&&$\begin{aligned}V_{dpb} &= \frac{2.5~ k_b~ d~ t~ f_u}{\gamma_{mb}}\\ &= \frac{2.5~*0.52*24.0*9.5*410}{1.25}\\ &=97.08\end{aligned}$&\\%
\hline%
Capacity (KN)&&$\begin{aligned}V_{db} &= min~ (V_{dsb}, V_{dpb})\\ &= min~ (97.08,97.08)\\ &=97.08\end{aligned}$&\\%
\hline%
No of Bolts&$\begin{aligned}R_{u} &= \sqrt{V_u^2+A_u^2}\\ n_{trial} &= R_u/ V_{bolt}\\ R_{u} &= \frac{\sqrt{150.0^2+30.0^2}}{97.08}\\ &=2\end{aligned}$&2&\\%
\hline%
No of Columns&&1&\\%
\hline%
No of Rows&&2&\\%
...
\hline%
Min. Gauge (mm)&$\begin{aligned}p/g_{min}&= 2.5 ~ d&\\ =&2.5*24.0&=60.0\end{aligned}$&180&Pass\\%
\hline%
Max. Gauge (mm)&$\begin{aligned}p/g_{max} &=\min(32~t,~300~mm)&\\ &=\min(32 *~9.5,~ 300 ~mm)\\&=304.0\end{aligned}$&180&Pass\\%
\hline%
Min. End Distance (mm)&$\begin{aligned}e/e`_{min} &=[1.5~or~ 1.7] * d_0\\ &=1.7*26.0=44.2 \end{aligned}$&45&Pass\\%
\hline%
Max. End Distance (mm)&$\begin{aligned}e/e`_{max} &= 12~ t~ \varepsilon&\\ \varepsilon &= \sqrt{\frac{250}{f_y}}\\ e/e`_{max}&=12 ~*10.0*\sqrt{\frac{250}{230}}\\ &=124.8\\ \end{aligned}$&45&Pass\\%
\hline%
Min. Edge Distance (mm)&$\begin{aligned}e/e`_{min} &=[1.5~or~ 1.7] * d_0\\ &=1.7*26.0=44.2 \end{aligned}$&45&Pass\\%
\hline%
Max. Edge Distance (mm)&$\begin{aligned}e/e`_{max} &= 12~ t~ \varepsilon&\\ \varepsilon &= \sqrt{\frac{250}{f_y}}\\ e/e`_{max}&=12 ~*10.0*\sqrt{\frac{250}{230}}\\ &=124.8\\ \end{aligned}$&45&Pass\\%
\hline%
Capacity (KN)&96569.64&97075.38&Pass\\%
\hline%
\end{longtable}
...
\endhead%
\hline%
Min. Plate Height (mm)&$\begin{aligned}0.6 * d_b&= 0.6 * 413.0=247.79999999999998\end{aligned}$&270&Pass\\%
\hline%
...
\hline%
Shear yielding Capacity (V\_dy) (kN)&&$\begin{aligned} V_{dg} &= \frac{A_v*f_y}{\sqrt{3}*\gamma_{mo}}\\ &=\frac{270*10.0*230}{\sqrt{3}*1.1}\\ &=195.56\end{aligned}$&\\%
\hline%
Shear Rupture Capacity (V\_dn) (kN)&&$\begin{aligned} V_{dn} &= \frac{0.75*A_{vn}*f_u}{\sqrt{3}*\gamma_{mo}}\\ &=1*(270-(2*26.0))*10.0*410\\ &=670.35\end{aligned}$&\\%
\hline%
Block Shear Capacity in Shear (V\_db) (kN)&&378.15&\\%
\hline%
Shear Capacity (V\_d) (kN)&150.0&$\begin{aligned} V_d &= Min(V_{dy},V_{dn},V_{db})\\ &= Min(195.56,670.35,378.15)\\ &=195.56\end{aligned}$&Pass\\%
\hline%
Tension Yielding Capacity (kN)&&$\begin{aligned} T_{dg} &= \frac{l*t*f_y}{\gamma_{mo}}\\ &=\frac{100.0*10.0*230}{\sqrt{3}*1.1}\\ &=209.09\end{aligned}$&\\%
\hline%
Tension Rupture Capacity(kN)&&$\begin{aligned} T_{dn} &= \frac{0.9*A_{n}*f_u}{\gamma_{m1}}\\ &=\frac{0.9*(100.0-2*26.0)*10.0*410}{1.25}\\ &=218.45\end{aligned}$&\\%
\hline%
Block Shear Capacity in Tension (T\_db) (kN)&&378.15&\\%
\hline%
Tension Capacity (kN)&30.0&$\begin{aligned} T_d &= Min(T_{dg},T_{dn},T_{db})\\ &= Min(209.09,218.45,378.15)\\ &=209.09\end{aligned}$&Pass\\%
\hline%
Moment Capacity (kNm)&8.25&30.49&Pass\\%
\hline%
Interaction Ratio&$\begin{aligned} \leq1\end{aligned}$&$\begin{aligned} \frac{8.25}{30.49}+\frac{30.0}{209.09}=0.41\end{aligned}$&Pass\\%
\hline%
\end{longtable}
...
\hline%
Max Weld Size (mm)&$\begin{aligned} Thickness~of~Thinner~part&\\ =Min(30.4,30.4)&=10.0\\ t_{w_{max}} &=10.0\end{aligned}$&6&Pass\\%
\hline%
Weld Strength (kN/mm)&$\begin{aligned} R_w&=\sqrt{(T_{wh}+A_{wh})^2 + (T_{wv}+V_{wv})^2}\\ T_{wh}&=\frac{M*y_{max}}{I{pw}}=\frac{8250000.0*129.0}{2862252.0}\\ T_{wv}&=\frac{M*x_{max}}{I{pw}}=\frac{8250000.0*0.0}{2862252.0}\\ V_{wv}&=\frac{V}{l_w}=\frac{150000.0}{516}\\ A_{wh}&=\frac{A}{l_w}=\frac{30000.0}{516}\\ R_w&=\sqrt{(371.82+58.14)^2 + (0.0+290.7)^2}\\ &=519.01\end{aligned}$&$\begin{aligned} f_w &=\frac{t_t*f_u}{\sqrt{3}*\gamma_{mw}}\\ &=\frac{4.2*410}{\sqrt{3}}*1.25\\ &=795.36\end{aligned}$&Pass\\%
\hline%
\end{longtable}
